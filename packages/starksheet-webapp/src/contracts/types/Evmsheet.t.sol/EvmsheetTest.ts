...
export interface EvmsheetTestInterface extends utils.Interface {
  functions: {
    ...
    "testAddSheet()": FunctionFragment;
    "testAddSheetShoultRevert()": FunctionFragment;
    "testMulticallAddSheet()": FunctionFragment;
    "testSetDefaultRenderer()": FunctionFragment;
    "testSetDefaultRendererShouldRevert()": FunctionFragment;
  };
...
export interface EvmsheetTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EvmsheetTestInterface;
  ...
  callStatic: {
    ...
    testAddSheet(overrides?: CallOverrides): Promise<void>;

    testAddSheetShoultRevert(overrides?: CallOverrides): Promise<void>;

    testMulticallAddSheet(overrides?: CallOverrides): Promise<void>;
