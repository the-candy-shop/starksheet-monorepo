...
export interface BasicCellRendererTestInterface extends utils.Interface {
  functions: {
    ...
    "testShouldRenderUri(uint256,bytes)": FunctionFragment;
  };
...
export interface BasicCellRendererTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BasicCellRendererTestInterface;
